...
const Key keymaps[][ROWS][COLS] PROGMEM = {
  ...
  (Key_RightBracket, Key_1,     Key_2, Key_3, Key_4, Key_5,     Key_Escape,
   Key_LeftBracket,  Key_Quote, Key_U, Key_F, Key_D, Key_B,     Key_RightAlt, 
   LSHIFT(Key_9),    Key_A,     Key_I, Key_S, Key_T, Key_Y,
   LSHIFT(Key_0),    Key_Z,     Key_X, Key_C, Key_V, Key_Minus, Key_Equals, 
   M(MACRO_EXCLAIM), M(MACRO_QUESTION), Key_Spacebar, Key_Backspace,
   ShiftToLayer(NUMPAD),

   M(MACRO_ANY),      Key_6,      Key_7, Key_8, Key_9, Key_0,     LSHIFT(Key_Tab),
   Key_RightShift,    Key_Redial, Key_H, Key_O, Key_G, Key_Slash, Key_Tab,
                      Key_M,      Key_N, Key_E, Key_R, Key_L,     TOPSY(Semicolon),   
   LockLayer(QWERTY), Key_J,      Key_P, Key_Q, Key_W, Key_K,     M(MACRO_SWAP), 
   Key_Delete, M(MACRO_FULLSTOP), M(MACRO_COMMA), Key_Enter,
  ...
  (___, ___, ___, ___, ___, ___, ___,  
   ...
   LSHIFT(Key_Comma),  ___, Key_LeftArrow, Key_DownArrow, Key_RightArrow, ___,
   LSHIFT(Key_Period), ___, ___, ___, ___, ___, ___,
   Key_LeftControl, Key_LeftShift, ___, ___,
   ___,

   M(MACRO_VERSION_INFO),  ___, Key_Keypad7, Key_Keypad8,   Key_Keypad9,     Key_KeypadSubtract, ___,
   ___,                    ___, Key_Keypad4, Key_Keypad5,   Key_Keypad6,     Key_KeypadAdd,      LSHIFT(Key_4),
   ...
   ___, Key_RightAlt, Key_LeftGui, Key_RightShift,
   ___),

  [FUNCTION] =  KEYMAP_STACKED
  (___, Key_F1, Key_F2,        Key_F3,        Key_F4,         Key_F5, Key_LEDEffectNext,
   ___, ___,    Key_Insert,    Key_UpArrow,   Key_Pause,      ___,    OSM(LeftShift),
   ___, ___,    Key_LeftArrow, Key_DownArrow, Key_RightArrow, ___,
   ___, ___,    ___,           ___,           ___,            ___,    M(MACRO_TOGGLE_QUKEYS),
   M(MACRO_EXCLAIM), M(MACRO_QUESTION), ___, ___,
   ___,
   ...
   ___, ___,    ___,    ___,    ___,    ___,     ___,
   ___, Key_Period, Key_Comma, M(MACRO_PARAGRAPH),
   ___),
...
static kaleidoscope::LEDSolidColor solidYellow(115, 115, 0);
static kaleidoscope::LEDSolidColor solidGreen(0, 160, 0);
static kaleidoscope::LEDSolidColor solidBlue(0, 70, 130);
static kaleidoscope::LEDSolidColor solidIndigo(0, 0, 170);
static kaleidoscope::LEDSolidColor solidViolet(130, 0, 120);
static kaleidoscope::LEDSolidColor solidWhite(90, 90, 90);
...
void setup() {
  ...
  //Qukeys Dictionaries
  QUKEYS(
     kaleidoscope::Qukey(0, 2, 8, Key_RightAlt),   //.(Macro) Alt
     kaleidoscope::Qukey(0, 1, 8, Key_LeftGui),    //,(Macro) Win
     kaleidoscope::Qukey(0, 0, 7, Key_LeftControl),//!(Macro) Ctrl
     kaleidoscope::Qukey(0, 1, 7, Key_LeftShift),  //?(Macro) Shift 
     kaleidoscope::Qukey(0, 0, 8, Key_RightShift), //Enter Shift
     )
